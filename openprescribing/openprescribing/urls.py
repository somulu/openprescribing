...
urlpatterns = [
    ...
    # Labs
    url(r'^data_for_equivalents/(?P<code>[A-Z\d]+)/(?P<date>[\d-]+)/graph.png$',
        labs_views.image_for_equivalents,
    ...
    url(r'^ccg/(?P<code>[A-Z\d]+)/price_per_dose/$',
        labs_views.price_per_dose,
